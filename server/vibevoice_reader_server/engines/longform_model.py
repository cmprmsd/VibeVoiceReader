# Vendored from https://github.com/vibevoice-community/VibeVoice (MIT), vibevoice/modular/modeling_vibevoice_inference.py
# Inference model for VibeVoice-1.5B / 7B; the installed microsoft `vibevoice` package lacks this file.
...
# (auto registration removed: the installed package maps VibeVoiceConfig elsewhere)
